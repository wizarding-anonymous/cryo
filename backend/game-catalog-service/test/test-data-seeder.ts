...
export class TestDataSeeder {
  ...
  async seedComprehensiveTestData(): Promise<Game[]> {
    const testGames: TestGameData[] = [
      // Popular AAA Games
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 10 64-bit, Processor: Intel Core i5-3570K or AMD FX-8310, Memory: 8 GB RAM',
          recommended:
            'OS: Windows 10 64-bit, Processor: Intel Core i7-4790 or AMD Ryzen 3 3200G, Memory: 12 GB RAM',
        },
        available: true,
      },
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 7 64-bit, Processor: Intel CPU Core i5-2500K 3.3GHz, Memory: 6 GB RAM',
          recommended:
            'OS: Windows 10 64-bit, Processor: Intel CPU Core i7 3770 3.4 GHz, Memory: 8 GB RAM',
        },
        available: true,
      },
      // Competitive Games
      {
        ...
        description:
          'The premier competitive FPS experience, featuring updated graphics and gameplay mechanics.',
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 10, Processor: 4 hardware CPU threads - Intel Core i5 750 or higher, Memory: 8 GB RAM',
          recommended:
            'OS: Windows 10, Processor: 4+ hardware CPU threads - Intel Core i5 750 or higher, Memory: 8 GB RAM',
        },
        available: true,
      },
      {
        title: 'Dota 2',
        description:
          'The most-played game on Steam. Every day, millions of players worldwide enter battle as one of over a hundred Dota heroes.',
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 7 or newer, Processor: Dual core from Intel or AMD at 2.8 GHz, Memory: 4 GB RAM',
          recommended:
            'OS: Windows 10, Processor: Dual core from Intel or AMD at 2.8 GHz, Memory: 8 GB RAM',
        },
        available: true,
      },
      // Indie Games
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 7, Processor: Intel Core 2 Duo E5200, Memory: 4 GB RAM',
          recommended:
            'OS: Windows 10, Processor: Intel Core i5, Memory: 8 GB RAM',
        },
        available: true,
      },
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 7, Processor: Intel Core i3 M380, Memory: 2 GB RAM',
          recommended:
            'OS: Windows 10, Processor: Intel Core i5-750, Memory: 4 GB RAM',
        },
        available: true,
      },
      // Strategy Games
      {
        ...
        description:
          'Build an empire to stand the test of time in the ultimate turn-based strategy experience.',
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 7 64bit / 8.1 64bit / 10 64bit, Processor: Intel Core i3 2.5 Ghz or AMD Phenom II 2.6 Ghz, Memory: 4 GB RAM',
          recommended:
            'OS: Windows 7 64bit / 8.1 64bit / 10 64bit, Processor: Fourth Generation Intel Core i5 2.5 Ghz or AMD FX8350 4.0 Ghz, Memory: 8 GB RAM',
        },
        available: true,
      },
      // Racing Games
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 10 version 15063.0, Processor: Intel i5-4460 or AMD Ryzen 3 1200, Memory: 8 GB RAM',
          recommended:
            'OS: Windows 10 version 15063.0, Processor: Intel i5-8400 or AMD Ryzen 5 1500X, Memory: 16 GB RAM',
        },
        available: true,
      },
      // Simulation Games
      {
        ...
        systemRequirements: {
          minimum:
            'OS: Microsoft Windows XP/Vista/7/8/8.1 (64-bit), Processor: Intel Core 2 Duo, 3.0GHz or AMD Athlon 64 X2 6400+, 3.2GHz, Memory: 4 GB RAM',
          recommended:
            'OS: Microsoft Windows 7/8 (64-bit), Processor: Intel Core i5-3470, 3.20GHz or AMD FX-6300, 3.5Ghz, Memory: 6 GB RAM',
        },
        available: true,
      },
      // Horror Games
      {
        title: 'Phasmophobia',
        description:
          'Phasmophobia is a 4 player online co-op psychological horror where you and your team investigate haunted locations.',
        ...
        systemRequirements: {
          minimum:
            'OS: Windows 10 64Bit, Processor: Intel Core i5-4590 / AMD FX 8350, Memory: 8 GB RAM',
          recommended:
            'OS: Windows 10 64Bit, Processor: Intel i5-4590/AMD Ryzen 5 2600, Memory: 8 GB RAM',
        },
        available: true,
      },
      // Unavailable/Delisted Games
      {
        ...
        description:
          'A game that has been removed from sale for testing purposes.',
      ...
      // Free Games
      {
        ...
        description:
          'A completely free game for testing free-to-play scenarios.',
      ...
      // High-priced Premium Games
      {
        ...
        description:
          'An expensive premium game for testing high-price scenarios.',
      ...
      // Games with special characters
      {
        ...
        description:
          'A game with Cyrillic characters for internationalization testing.',
  ...
  async seedSearchTestData(): Promise<Game[]> {
    const searchGames: TestGameData[] = [
      ...
      },
      {
        ...
        description:
          'A game with common words in the description for search testing',
        price: 29.99,
        genre: 'Common',
  ...
  async cleanTestDataByPattern(titlePattern: string): Promise<void> {
    ...
    if (games.length > 0) {
      ...
      console.log(
        `Cleaned ${games.length} test games matching pattern: ${titlePattern}`,
      );
    }
  }
