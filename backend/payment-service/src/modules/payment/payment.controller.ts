...
export class PaymentController {
  ...
  @ApiResponse({ status: 201, description: 'Returns the URL for the payment provider.' })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 404, description: 'Payment not found.' })
  @ApiResponse({ status: 409, description: 'Payment has been already processed.' })
  ...
  @ApiResponse({ status: 200, description: 'The payment details.', type: Payment })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  @ApiResponse({ status: 404, description: 'Payment not found.' })
