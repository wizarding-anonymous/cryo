...
describe('MockFormsController', () => {
  ...
  describe('showSberbankForm', () => {
    it('should return Sberbank form data', async () => {
      const result = await controller.showSberbankForm(
        'test-payment-id',
        'test-external-id',
      );
  ...
  describe('showYMoneyForm', () => {
    it('should return YMoney form data', async () => {
      const result = await controller.showYMoneyForm(
        'test-payment-id',
        'test-external-id',
      );
  ...
  describe('showTBankForm', () => {
    it('should return T-Bank form data', async () => {
      const result = await controller.showTBankForm(
        'test-payment-id',
        'test-external-id',
      );
  ...
  describe('processSberbankPayment', () => {
    it('should confirm payment when action is confirm', async () => {
      const result = await controller.processSberbankPayment(
        'test-payment-id',
        {
          action: 'confirm',
          externalId: 'test-external-id',
