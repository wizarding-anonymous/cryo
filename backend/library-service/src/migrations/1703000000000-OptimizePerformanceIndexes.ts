...
export class OptimizePerformanceIndexes1703000000000
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_user_purchase_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_user_price";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_user_currency_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_game_purchase_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_order_purchase";`,
    );

    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_user_created_at";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_user_status_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_user_amount";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_user_currency_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_game_user_date";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_payment_method";`,
    );

    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_completed_status";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_recent_purchases";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_metadata_gin";`,
    );

    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_covering_basic";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_covering_basic";`,
    );

    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_library_games_join_history";`,
    );
    await queryRunner.query(
      `DROP INDEX CONCURRENTLY IF EXISTS "IDX_purchase_history_join_library";`,
    );
  }
}
