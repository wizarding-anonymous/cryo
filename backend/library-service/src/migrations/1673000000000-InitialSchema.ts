  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "library_games" (
        ...
        CONSTRAINT "UQ_library_games_userId_gameId" UNIQUE ("userId", "gameId"),
    ...
    await queryRunner.query(`
      CREATE INDEX "IDX_purchase_history_gameId" ON "purchase_history" ("gameId")
    `);

    await queryRunner.query(`
      CREATE INDEX "IDX_purchase_history_orderId" ON "purchase_history" ("orderId")
    `);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_purchase_history_orderId"`);
    await queryRunner.query(`DROP INDEX "IDX_purchase_history_gameId"`);
