...
describe('GracefulShutdownService', () => {
  ...
  it('should create database shutdown handler', () => {
    ...
    const handler =
      GracefulShutdownService.createDatabaseShutdownHandler(mockDataSource);
  ...
  it('should create redis shutdown handler', () => {
    ...
    const handler =
      GracefulShutdownService.createRedisShutdownHandler(mockRedisClient);
  ...
  it('should create HTTP server shutdown handler', () => {
    ...
    const handler =
      GracefulShutdownService.createHttpServerShutdownHandler(mockServer);
  ...
  it('should create Kafka shutdown handler', () => {
    ...
    const handler =
      GracefulShutdownService.createKafkaShutdownHandler(mockKafkaClient);
  ...
  it('should create cache shutdown handler', () => {
    ...
    const handler =
      GracefulShutdownService.createCacheShutdownHandler(mockCacheManager);
  ...
  describe('shutdown handlers execution', () => {
    ...
    it('should handle missing server in HTTP shutdown handler', async () => {
      const handler =
        GracefulShutdownService.createHttpServerShutdownHandler(null);
  ...
  describe('onApplicationShutdown', () => {
    it('should handle application shutdown with signal', async () => {
      const initiateShutdownSpy = jest
        .spyOn(service as any, 'initiateShutdown')
