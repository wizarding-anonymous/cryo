...
export class RefactorTokensTable1724585276944 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Add the new column
        await queryRunner.query(`ALTER TABLE "user_tokens" ADD COLUMN "token_type" VARCHAR(50) NOT NULL DEFAULT 'activation'`);

        // Add new indexes
        await queryRunner.query(`CREATE INDEX "idx_user_tokens_token_type" ON "user_tokens"("token_type")`);
        await queryRunner.query(`CREATE INDEX "idx_user_tokens_user_id_token_type" ON "user_tokens"("user_id", "token_type")`);
        ...
        await queryRunner.query(`ALTER INDEX "idx_user_activation_tokens_expires_at" RENAME TO "idx_user_tokens_expires_at"`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER INDEX "idx_user_tokens_expires_at" RENAME TO "idx_user_activation_tokens_expires_at"`);
    }
