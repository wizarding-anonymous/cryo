...
export class MockExternalIntegrationService {
  ...
  constructor(private readonly circuitBreakerService: CircuitBreakerService) {
    this.circuitBreakerService.createBreaker('steam-api', this.callSteamApi.bind(this));
    this.circuitBreakerService.createBreaker('epic-api', this.callEpicApi.bind(this));
  }
