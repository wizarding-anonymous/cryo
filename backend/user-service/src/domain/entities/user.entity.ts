...
export class User {
  ...
  @Column({ type: 'jsonb', nullable: true, name: 'customization_preferences' })
  customizationPreferences?: object;
  ...
  @Column({ type: 'boolean', default: false, name: 'created_via_sso' })
  createdViaSSO?: boolean;

  @Column({ type: 'varchar', length: 255, nullable: true, name: 'sso_provider_id' })
