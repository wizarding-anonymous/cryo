...
describe('AchievementService', () => {
    ...
    describe('getUserAchievements', () => {
        ...
        it('should fetch from database with pagination', async () => {
            ...
            expect(mockQueryBuilder.leftJoinAndSelect).toHaveBeenCalledWith('ua.achievement', 'achievement');
        ...
        it('should apply type filter when provided', async () => {
            ...
            const result = await service.getUserAchievements(userId, { page: 1, limit: 10, type: 'first_purchase' });

            expect(mockQueryBuilder.andWhere).toHaveBeenCalledWith('achievement.type = :type', { type: 'first_purchase' });
        });
        ...
        it('should filter unlocked achievements when unlocked=true', async () => {
            ...
            const result = await service.getUserAchievements(userId, { page: 1, limit: 10, unlocked: true });
        ...
        it('should filter locked achievements when unlocked=false', async () => {
            ...
            const result = await service.getUserAchievements(userId, { page: 1, limit: 10, unlocked: false });
